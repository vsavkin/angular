...
function _getChangeDetectorDefinitionIds(hostComponentMetadata: RenderDirectiveMetadata,
    ...
    string[] {
  return nestedPvsWithIndex.map(pvWithIndex =>
                                    _changeDetectorId(hostComponentMetadata, pvWithIndex));
}

function _changeDetectorId(hostComponentMetadata: RenderDirectiveMetadata,
