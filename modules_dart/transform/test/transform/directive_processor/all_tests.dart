...
void allTests() {
  ...
  describe('directives', () {
    ...
    it('should populate `providers` using useValue (num token).',
        () async {
      var cmp =
      (await _testCreateModel('directives_files/components.dart')).identifiers['ComponentWithProvidersUseValueNum'];
      ...
      expect(useValue).toEqual(42);
    });

    it('should populate `providers` using useValue (bool token).',
        () async {
      var cmp =
      (await _testCreateModel('directives_files/components.dart')).identifiers['ComponentWithProvidersUseValueBool'];
      ...
      expect(useValue).toEqual(true);
    });

    it('should populate `providers` using useValue (null token).',
        () async {
      var cmp =
      (await _testCreateModel('directives_files/components.dart')).identifiers['ComponentWithProvidersUseValueNull'];
